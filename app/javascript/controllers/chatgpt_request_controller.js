...
export default class extends Controller {
  ...
  loader() {
    var phrases = ["Ticket to chatGPT", "Waiting for David","def wakingUp(Tal)", "def initialize antoine", "Asking Maewenn", "Harceling Loris", "No thanks to Dylan", "Deleting S.Saunier", "Pushing on main", "def phoneCase(Théo)", "Shuffling bits", "Waiting for response", "Generating pages", "Simulating workflow", "Empowering humanity", "Who use Ruby?", "Fueling the idea", "Fixing CSS", "Talking to server", "Fetching data"];
